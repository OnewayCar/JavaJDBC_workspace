...
//해시함수 : 문자열을 전달받아서 해시코드(평문->암호화된문자열)로 변환. **해시코드를 평문으로 변환하지는 못함.
//         패스워드를 저장할 때 해시값으로 저장.해시값은 해시함수에 따라 고정된 길이로 생성
//      대표적인 해시함수로 sha256, sha512 함수등은 각각 256비트 또는 512 비트 길이로 해시값 만듭니다.
//      외부 라이브러리 guava(google)를 사용하면 sha256 메소드가 있습니다.

// 암호를 '1234'로 정하면 DB에는 해시코드로 변환하여 저장합니다.
...
public class HashFunctionTest {
	...
	public static void main(String[] args) {
		...
		// 256비트 나누기 4 하면 64개의 16진수 문자열로 바뀐다.
		// 03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4 : DB에 저장되는 값
